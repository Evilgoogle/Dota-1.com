        ...
        <div class="form_center">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="form_header_block">
                        ...
                        <div class="mobile_center">
                            <span>Табличный шаблон - <?php echo hc($_GET['template_id']);?></span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="des" class="form-control form_des"><?php echo @hc($_POST['des'],'on');?></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="form_header_block">
                        ...
                        <div class="mobile_center">
                            <span>itemscope itemtype - <?php echo (!empty($_GET['itemtype'])) ? $_GET['itemtype'] : 'Не определен';?></span>
                        </div>
                        <div class="mobile_bottom">
                            <div class="m_left"></div>
                            <div class="m_center"></div>
                    ...
                    <div class="form_data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="itemprop_views" class="form-control" value="<?php echo @hc($_POST['itemprop_views'],'on');?>">
